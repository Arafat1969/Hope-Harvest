...
public class EventUpdateRequestDTO {
    ...
    public EventUpdateRequestDTO(String description, ZonedDateTime startDate, ZonedDateTime endDate, String locationAddress, String locationCity, String locationDistrict, String status, List<RequiredGood> requiredGoods, BigDecimal budgetAmount) {
