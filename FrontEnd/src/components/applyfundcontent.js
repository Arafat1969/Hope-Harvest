...
const ApplyFundsLayout = () => {
  ...
  const handleButtonHover = (e, isHover) => {
    if (isHover) {
      ...
      e.target.style.boxShadow = '0 12px 40px rgba(76, 175, 80, 0.6)';    } else {
    ...
    <div style={styles.mainContainer}>
      <div className="container">
        ...
        <div style={styles.heroSection}>
          ...
          <h1 className="display-3 fw-bold mb-4">Financial Support Application</h1>
          <p className="lead mb-4" style={{ fontSize: '1.3rem' }}>
            A transparent, step-by-step process to help those in need access financial assistance
          </p>
