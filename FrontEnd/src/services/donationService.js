...
export const donationService = {
  ...
  getAllDonations: async () => {
    const response = await authAxios.get(`${API_BASE_URLs.DONATION_SERVICE}/admin/donations`);
    return response.data;
  },


  getDonationByDonationId: async (donationId) => {
    const response = await authAxios.get(`${API_BASE_URLs.DONATION_SERVICE}/admin/donations/${donationId}`);
    return response.data;
  },
  ...
  getDonationsByCampaign: async (campaignId) => {
    const response = await authAxios.get(`${API_BASE_URLs.DONATION_SERVICE}/admin/donations/${campaignId}`);
    return response.data;
  },


  // Record donation usage (admin)
  recordDonationUsage: async (donationId, donationUsageData) => {
    const response = await authAxios.post(`${API_BASE_URLs.DONATION_SERVICE}/admin/donations/${donationId}/usage`, donationUsageData);
    return response.data;
  },
  ...
  //   const response = await authAxios.get(`${API_BASE_URLs.DONATION_SERVICE}/admin/donations/recent`);
  //   return response.data;
  // },
